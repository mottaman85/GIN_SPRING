...
public class MyController {
	...
	public String helloURITemplate3(@PathVariable int helloId,
	...
	public String helloURITemplate4(@PathVariable int helloId,
			@PathVariable String greeting, ModelMap model) {
		model.addAttribute("message" + helloId,
				"message" + helloId + " is selected!").addAttribute("mygreeting",
				"Greeting message is " + greeting);
